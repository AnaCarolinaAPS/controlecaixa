...
@section('titulo', 'Subcategorias | PowerTrade.Py')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Subcategorias</h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr data-href="{{ route('subcategorias.show', ['subcategoria' => $subcategoria->id]) }}">
                                        <td><h6 class="mb-0">{{ $subcategoria->id }}</h6></td>
                                        <td>{{ $subcategoria->nome }}</td>
                                        <td>{{ \Carbon\Carbon::parse($subcategoria->created_at)->format('d/m/Y H:i') }}</td>
                                    </tr>
                                    @endforeach
                                     <!-- end -->
                                </tbody><!-- end tbody -->
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="ModalShipper" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal mt-3" method="POST" action="{{ route('subcategorias.store') }}">
                    @csrf
